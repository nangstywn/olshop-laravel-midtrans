                    ...
                    <tr>
                        <td>
                            <a href="{{ route('product', $basket_product->product->slug) }}">
                                ...
                                <img class="img-responsive" style="width: 50px;" src="/uploads/{{ $image->name }}">
                                @endforeach
                            </a>
                        </td>
                        <td>
                        ...
                        <td>{{ Rupiah::getRupiah($basket_product->price) }}</td>
                        <td>{{ $basket_product->quantity }}</td>
                        <td>{{ Rupiah::getRupiah($basket_product->price * $basket_product->quantity) }}</td>
                    </tr>
                    @endforeach
                    <tr>
                        <th colspan="4" class="text-right">TOTAL(VAT INCLUDED)</th>
                        <td colspan="2">{{ Rupiah::getRupiah($order->order_price) }}</td>
                    </tr>
