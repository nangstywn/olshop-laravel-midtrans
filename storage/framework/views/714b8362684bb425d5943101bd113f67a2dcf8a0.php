...
<head>
    <title>Laravel Store - <?php echo e(config('app.name')); ?> </title>
    <meta charset="utf-8">
...
<body data-status="<?php echo e(Session::get("status")); ?>">
                        ...
                        <div class="col-lg-12 text-right">
                            ...
                            <nav class="navbar">
                                <ul class="navbar_menu">
                                    ...
                                    <a style="color: inherit;" class="dropdown-toggle" href="#" id="dropdownMenuLink"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item"
                                            href=" /category/<?php echo e($menu->slug); ?>"><?php echo e($menu->category_name); ?></a>
    ...
    $(window).scroll(function() {
        // // alert('a')
        // let sticky = $('.main_nav_container').offset();
        // let nav = sticky.top
        // alert(this.scrollY)
        // if (this.scrollY > 50) {
        //     $('.main_nav_container').addClass("sticky");
        // } else
        //     $('.main_nav_container').removeClass("sticky");
    });
    </script>
